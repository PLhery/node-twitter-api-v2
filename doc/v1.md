...
* [Users](#Users)
  ...
  * [Returns the 20 most recent Tweets liked by the authenticating or specified user](#ListFavorites)
* [Account](#Account)
...
### <a name='ListFavorites'></a>Returns the 20 most recent Tweets liked by the authenticating or specified user
...
**Arguments**:
  - `options?: ListFavoritesV1Params`

**Returns**: `TweetV1[]`

**Example**
```ts
const tweets = await client.v1.listFavorites();
```
...
### <a name='Getlistoflistsofuser'></a>Get list of lists of user
...
### <a name='Listmemberships'></a>List memberships
